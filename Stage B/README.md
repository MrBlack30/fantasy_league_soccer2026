...
למה הוספנו מגבלות**?**
הוספנו את המגבלות כדי לשמור על תקינות הנתונים ועל כללי העסק של המערכת:

גיל מינימום 18 — כדי לוודא שרק משתמשים בוגרים נרשמים למערכת, בהתאם לדרישות חוקיות או תנאי שימוש.
איסור על משתמשים מאיראן — כדי לעמוד בסנקציות בינלאומיות או מגבלות רגולטוריות החלות על השירות.
ייחודיות של user_id — כדי למנוע מצב שבו שני משתמשים שונים מקבלים את אותו מזהה, דבר שעלול לגרום לבאגים חמורים ובלבול במערכת.
